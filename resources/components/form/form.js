...
export default {
  ...
  methods: {
    ...
    getTypes() {
      return 
       [
        {value: 'tithe', label: 'form.types.TIthes'  },
        { value: 'offering',label: 'form.types.Offering'  },
        { value: 'thanksgiving', label: 'form.types.Thanksgiving Offering' },
        {  value: 'pledge',label: 'form.types.Building Fund Offering / Pledge' }
      ];
    },
